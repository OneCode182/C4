...
import usa.ciclo4.reto5.repositories.CloneRepo;
...
public class CloneService {
    ...
    // ALGORITHM CHECK SUBSTRING INTO STRINGROOT
    ...
    public List<Clone> findByDescription(String description2){
        List <Clone> items = repository.getAll();
        ArrayList<Clone> items2 = new ArrayList();
        for(Clone item: items){
